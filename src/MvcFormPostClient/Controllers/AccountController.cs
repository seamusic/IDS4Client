...
namespace MvcFormPostClient.Controllers
{
	public class AccountController : Controller
	{
		public ActionResult SignIn()
		{
			...
			var url = "http://localhost:5000/connect/deviceauthorization" +
				"?client_id=nolibclient" +
				"&response_type=id_token" +
				"&scope=openid email" +
				"&redirect_uri=http://localhost:7862/account/signInCallback" +
